...
class CreateShiftForm(forms.ModelForm):
    ...
    trucks = [(415,'415'),(501,'501'),(502,'502'),(503,'503'),(504,'504'),(203,'203'),(101,'101'),(11,'11'),(12,'12'),(13,'13'),(14,'14'),(15,'15'),(16,'16'),(17,'17'),(18,'18'),]
...
JobsInlineFormset = inlineformset_factory(models.Shift, models.Job, extra=15, max_num=18, can_delete=True, form=CreateJobForm, fields=('job_location','job_shift','start_time','end_time','order','pick','blow','sweep'))
